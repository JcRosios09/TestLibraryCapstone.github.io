...
<h1 style="color: #d4b050; font-size: 20px;display: inline-block; margin-top: 45px; padding-left: 5px;">CTU-CONSOLACION BOOK MONITORING SYSTEM</h1>	
		<?php
		...
		<div id="slider">		
			...
			<img src="images/libraryinsight4.jpg">
		</figure>
		</div>
		<div class="linebar1">
			<h1>VMGO</h1>
