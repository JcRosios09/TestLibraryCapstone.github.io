...
<body style="background-color: #303026;">
	...
	<div class="profile_info" style="text-align: center;">
		...
		<h4 style="color: white"> <b >Welcome, </b><?php
		echo $_SESSION['login_user']; ?></h4>
	</div><br><br>
	...
	<div class="form1">
		...
		<div style="text-align: center;">
			<button class="btn btn-default" type="submit" name="submit" style="color: black; width: 90px; height: 35px;background-color: #8f8888;color:#fff;">save</button></div>
	</form>
</div>
	<?php 
