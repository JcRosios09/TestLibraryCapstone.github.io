...
<div id="main">
  ...
  <div class="container">
    <h3 style="font-size: 25px;font-family: Montserrat, sans-serif;font-weight: 800;  text-transform: uppercase; text-align: center;">Information of Borrowed Books</h3><br>
    <?php
    $c=0;
