  ...
  document.body.style.backgroundColor = "white";
	...
	<div class="srch">
		...
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #8f8888;color:#fff" type="submit" name="submit1" class="btn btn-default">Delete
				</button>
		</form>
	</div>

	<h2 style="font-size: 25px;font-family: Montserrat, sans-serif;font-weight: 800;  text-transform: uppercase;">List Of Books</h2>
