...
<div class="container">
	<div class="srch">
		...
		<form method="post" action="" name="form1">
			...
			<button class="btn btn-default" name="submit" type="submit" style="background-color: #8f8888;color:#fff;">Submit</button><br>
		</form>
	</div>

	<h3 style="font-size: 25px;font-family: Montserrat, sans-serif;font-weight: 800;  text-transform: uppercase; text-align: center;">Request of Book</h3>
