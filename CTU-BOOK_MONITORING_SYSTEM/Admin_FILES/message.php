...
<div class="right_box">
  ...
  <!---------show message----------->
            ...
            ?>
              ...
              <br><div class="chat user">
                <div style="float: left; padding-top: 5px;">
                  &nbsp
                  <img style="height: 40px; width: 40px; border-radius: 50%;" src="images/User-Profile-PNG-File.png">
                  &nbsp
                </div>
     ...
     else
     {
      ...
      {
        ?>
          <img style="margin: 100px 80px; border-radius: 50%; height: 350px; width: 350px; margin-left: 125px;" src="images/CTU_new_logo.png" alt="animated">
        <?php
      }
      else
      {
          ...
          <h3 style="margin-top: -5px; padding-top: 10px;"> <?php echo $_SESSION['username'] ?> </h3>
            ...
            ?>
              ...
              <br><div class="chat user">
                <div style="float: left; padding-top: 5px;">
                  &nbsp
                  <img style="height: 40px; width: 40px; border-radius: 50%;" src="images/User-Profile-PNG-File.png">&nbsp
                </div>
                <div style="float: left;" class="chatbox">
                  <?php
                    echo $row['message'];
